        ...
        <Card>
          <Card.Body>
            <article>
              ...
              <p>
                Volt React Dashboard is a React.js and Bootstrap 5 powered admin dashboard template
              ...
              <p>
                We offer 6 months of support by default for each purchased template. Please{' '}
              ...
              <ul className="docs-list">
                <li>
                  Follow{' '}
                  <Card.Link href="https://twitter.com/themesberg" target="_blank">
                ...
                <li>
                  Follow{' '}
                  <Card.Link href="https://facebook.com/themesberg" target="_blank">
                ...
                <li>
                  ...
                  <Card.Link href="https://github.com/themesberg" target="_blank">
                    Github Page
                  </Card.Link>
                </li>
              </ul>

...
export default () => {
    ...
    <article>
      <Container className="px-0">
        ...
        <Documentation
          ...
          description={
            <p>
              Use the <code>&#x3C;OverlayTrigger&#x3E;</code> and <code>&#x3C;Tooltip&#x3E;</code>{' '}
              to show extra information when hovering or clicking on a given element. Make sure to
              wrap both the triggering element (ie. a button) and the{' '}
  ...
  <Button variant="secondary" size="sm" className="m-2">Tooltip on top</Button>
        ...
        <Documentation
          ...
          description={
            <p>
              You can also easily position the <code>&#x3C;Tooltip&#x3E;</code> component in any
              direction using the <code>placement="*"</code> attribute, where the value can be{' '}

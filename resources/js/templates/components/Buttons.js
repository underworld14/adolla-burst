...
export default () => {
      ...
      <Container className="px-0">
        <Row className="d-flex flex-wrap flex-md-nowrap align-items-center py-4">
          <Col className="d-block mb-4 mb-md-0">
            ...
            <p className="mb-0">
              Use custom button styles for actions in forms, dialogs, and more with support for
        ...
        <Documentation
          ...
          description={
            <p>
              The <code>&#x3C;Button&#x3E;</code> component is an important part of the UI that you
              can use for user actions. If you want to change the appearance of a given button, you
              can update the modifier props of the <code>variant</code> attribute.
            </p>
          }
          scope={{ Button }}
  ...
  <Button variant="white" className="m-1">White</Button>
        ...
        <Documentation
          ...
          description={
            <p>
              The <code>&#x3C;Button&#x3E;</code> component comes with three main sizing options:{' '}
              <code>sm</code>, default, and <code>lg</code>. In order to change the size of the
              button you need to set the size using the <code>size</code> attribute.
            </p>
          }
          scope={{ Button }}
          imports={`import { Button } from '@themesberg/react-bootstrap';`}
  ...
  <Button variant="primary" size="lg" className="me-1">Large Button</Button>
        ...
        <Documentation
          ...
          description={
            <p>
              Instead of a fully colored background, you can also choose to style the{' '}
              <code>&#x3C;Button&#x3E;</code> component to only have an outline border by using the{' '}
              <code>outline-primary</code>, <code>outline-secondary</code> modifier classes inside
        ...
        <Documentation
          ...
          description={
            <p>
              ...
              appearance of a button, just use the <code>bsPrefix="text"</code> attribute to create
              link styled buttons.
            </p>
          }
          scope={{ Button }}
  ...
  <Button bsPrefix="text" href="#gray" variant="gray" className="m-3">Gray</Button>
        ...
        <Documentation
          ...
          description={
            <p>
              You may want to use icons inside the <code>&#x3C;Button&#x3E;</code> component, which
              can be done by simply adding a <code>&#x3C;FontAwesomeIcon&#x3E;</code> component
  ...
  <Button variant="outline-secondary" className="m-1">
    <FontAwesomeIcon icon={faThumbsUp} className="me-2" /> Secondary
        ...
        <Documentation
          ...
          description={
            <p>
              Block level buttons are great if you want the button to take up 100% of the width of
              the parent element. You need to add the <code>w-100</code> class to the component.
            </p>
          }
          scope={{ Button }}
          imports={`import { Button } from '@themesberg/react-bootstrap';`}
        ...
        <Documentation
          ...
          description={
            <p>
              ...
              reasons, so you need to add the <code>disabled</code> attribute in order to achieve
              that.
            </p>
          }
          scope={{ Button }}
    ...
    Button
        ...
        <Documentation
          ...
          description={
            <>
              <p>
                Use the <code>&#x3C;Dropdown&#x3E;</code> component coupled with the{' '}
                <code>&#x3C;Button&#x3E;</code> component in order to create dropdown items when
                clicking on a button. The <code> &#x3C;Dropdown.Toggle&#x3E;</code> is the component
                that will trigger the dropdown menu, while the{' '}
                <code>&#x3C;Dropdown.Menu&#x3E;</code> is the actual menu where you can add the
                dropdown items.
              </p>
              <p>
                The <code>&#x3C;Button&#x3E;</code> component is used either before or after the
                toggle component, but all of this is wrapped around with the main{' '}
        ...
        <Documentation
          ...
          description={
            <p>
              ...
              <code>&#x3C;Dropdown&#x3E;</code> component, so in order to do that you only need to
              use the <code>size="md"</code> or <code>size="lg"</code> attributes for the{' '}
              <code>&#x3C;Button&#x3E;</code> component inside the dropdown component.
            </p>
          }
          scope={{ Button, Dropdown, ButtonGroup, FontAwesomeIcon, faAngleDown }}
    ...
    <Dropdown.Menu>
      ...
      <Dropdown.Item href="#action">Separated link</Dropdown.Item>
        ...
        <Documentation
          ...
          description={
            <p>
              If you want to change the direction of the <code>&#x3C;Dropdown&#x3E;</code>{' '}
              component, you can do that by using the <code>direction="*"</code> attribute where you
              can use <code>up</code>, <code>right</code>, <code>down</code>, or <code>left</code>{' '}
              as attribute values.
            </p>
          }
          scope={{

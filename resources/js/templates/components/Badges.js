...
export default () => (
  <article>
    <Container className="px-0">
      ...
      <Documentation
        ...
        description={
          <p>
            Use the <code>&#x3C;Badge&#x3E;</code> component to show and highlight labeled text. You
            can update the colors using the following modifier classes (ie. <code>bg-primary</code>,{' '}
  ...
  <Badge bg="dark">Dark</Badge>
      ...
      <Documentation
        ...
        description={
          <p>
            To update the size of the <code>&#x3C;Badge&#x3E;</code> component you can use the size
            modified classes, such as <code>badge-md</code> or <code>badge-lg</code>.
          </p>
        }
        scope={{ Badge }}
        imports={`import { Badge } from '@themesberg/react-bootstrap';`}
  ...
  <Badge bg="success" className="badge-lg">Success</Badge>
      ...
      <Documentation
        ...
        description={
          <p>
            Set the <code>pill</code> on <code>true</code> property to make badges more rounded with
            a larger border radius.
          </p>
        }
        scope={{ Badge }}
        imports={`import { Badge } from '@themesberg/react-bootstrap';`}

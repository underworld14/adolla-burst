...
export default () => {
    ...
    <article>
      <Container className="px-0">
        ...
        <Documentation
          ...
          description={
            <p>
              The <code>&#x3C;OverlayTrigger&#x3E;</code> and <code>&#x3C;Popover&#x3E;</code>{' '}
              component can be used to show extra information by clicking on a given element. You
              can set the title and content using the <code>&#x3C;Popover.Title&#x3E;</code> and{' '}
              <code>&#x3C;Popover.Content&#x3E;</code> subcomponents. Make sure you wrap the{' '}
              <code>&#x3C;OverlayTrigger&#x3E;</code> component around the popover and the element
  ...
  <Button variant="secondary" size="sm" className="m-2">Popover on top</Button>
        ...
        <Documentation
          ...
          description={
            <p>
              The <code>&#x3C;Popover&#x3E;</code> can also be positioned accordingly, using the{' '}
              <code>placement="*"</code> attribute, where the value can be either <code>top</code>,{' '}

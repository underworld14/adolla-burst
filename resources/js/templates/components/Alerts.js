      ...
      <Container className="px-0">
        <Row className="d-flex flex-wrap flex-md-nowrap align-items-center py-4">
          <Col className="d-block mb-4 mb-md-0">
            ...
            <p className="mb-0">
              Use alerts to provide contextual feedback to your users based on their input and
              behaviour.
            </p>
          </Col>
        </Row>
        ...
        <Documentation
          ...
          description={
            <p>
              ...
              success, informational or warning messages. Use component properties such as{' '}
              <code>variant="primary</code> or <code>variant="secondary"</code> to use the colors
  ...
  <Alert variant="dark">
    A simple dark alert — check it out!
        ...
        <Documentation
          ...
          description={
            <p>
              The <code>&#x3C;Alert&#x3E;</code> component can be used to create an alert component
              that can be closed by clicking on the close icon by adding the <code>show</code> and{' '}
              <code>onClose</code> properties. Additionally, you can also use the{' '}
              <code>&#x3C;FontAwesomeIcon&#x3E;</code> component to add an icon inside the alert
              component.
            </p>
          }

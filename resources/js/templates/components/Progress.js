    ...
    <Container className="px-0">
      <Row className="d-flex flex-wrap flex-md-nowrap align-items-center py-4">
        <Col className="d-block mb-4 mb-md-0">
          ...
          <p className="mb-0">Use progress bars to indicate percentage based components.</p>
        </Col>
      </Row>
      ...
      <Documentation
        ...
        description={
          <p>
            Use the <code>&#x3C;Progress&#x3E;</code> component to show progress bars or loaders for
            your app. You can set the value of the bar using the <code>value</code> attribute. You
            can also change the appearance using the <code>variant="*"</code> attributes using the
            default Bootstrap color classes, such as <code>primary</code>, <code>secondary</code>,{' '}
      ...
      <Documentation
        ...
        description={
          <p>
            To update the appearance of the <code>&#x3C;Progress&#x3E;</code> component you can use
            the following classes for the <code>variant</code> attribute. You can also add a label
            text using the <code>label="lorem ipsum"</code> attribute.
          </p>
        }
        scope={{ Progress }}
        imports={`import Progress from "src/components/Progress";`}
      ...
      <Documentation
        ...
        description={
          <p>
            ...
            <code>&#x3C;Progress&#x3E;</code> updating the <code>size="*"</code> attribute.
          </p>
        }
        scope={{ Progress }}
        imports={`import Progress from "src/components/Progress";`}

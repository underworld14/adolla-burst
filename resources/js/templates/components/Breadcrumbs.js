        ...
        <Documentation
          ...
          description={
            <p>
              ...
              hierarchy for your users, wherever they may be on a given page. Using the{' '}
              <code>variant</code> modifier props you can update the color of the component.
            </p>
          }
  ...
  <Col lg={6}>
    ...
    <Breadcrumb listProps={{ className: "breadcrumb-info breadcrumb-text-light text-white" }}>
        ...
        <Documentation
          ...
          description={
            <p>
              In order to make the <code>&#x3C;Breadcrumb&#x3E;</code> component transparent, all
              you need to do is add the <code>breadcrumb-transparent</code> modifier class to the
              parent component.
            </p>
          }
          scope={{ Row, Col, Breadcrumb }}

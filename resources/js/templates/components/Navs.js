    ...
    <Container className="px-0">
      <Row className="d-flex flex-wrap flex-md-nowrap align-items-center py-4">
        <Col className="d-block mb-4 mb-md-0">
          ...
          <p className="mb-0">Use navigation tabs to break up pieces of content.</p>
        </Col>
      </Row>
      ...
      <Documentation
        ...
        description={
          <p>
            The <code>&#x3C;Nav&#x3E;</code> component should be used for app navigation, such as
            for the navigation bar, a secondary menu, or other. The{' '}
            <code>&#x3C;Nav.Link&#x3E;</code> component can be attributed with the location of the
            link.
          </p>
        }
        scope={{ Nav, Row, Col }}
  ...
  <Col lg={6}>
    <Nav fill defaultActiveKey="home" variant="pills" className="flex-column flex-sm-row">
      ...
      <Documentation
        ...
        description={
          <p>
            If you want the nav style to be rounded, just add the <code>rounded</code> class name to
            the main <code>&#x3C;Nav.Link&#x3E;</code> component.
          </p>
        }
        scope={{ Nav, Row, Col }}
        imports={`import { Nav } from '@themesberg/react-bootstrap';`}
  ...
  <Col lg={6}>
    <Nav fill defaultActiveKey="home" variant="pills" className="rounded flex-column flex-md-row">
      ...
      <Documentation
        ...
        description={
          <p>
            If you want to add other content to a navigation item, such as an icon, you can do that
            by{' '}
          </p>
        }
